...
public class CSVgenerator_Gift {
    public void generate(ArrayList<couples> arrayListcouples) throws FileNotFoundException {
        ...
        for (couples couples : arrayListcouples) {
            ...
            sb.append(',');
            sb.append(couples.num_ess);
            sb.append(',');
            sb.append(couples.num_lux);
            sb.append(',');
            sb.append(couples.num_util);
            sb.append(',');
            sb.append(couples.happiness_couple());
            sb.append(',');
            sb.append('\n');
        }
